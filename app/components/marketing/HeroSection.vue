...
<template>
    ...
    >
        <!-- dotted grid bg -->
        <div
            class="pointer-events-none absolute inset-0 bg-size-[20px_20px] bg-[radial-gradient(circle,rgba(0,0,0,0.045)_1px,transparent_1px)] mask-[radial-gradient(ellipse_at_center,black_40%,transparent_80%)]"
        />
